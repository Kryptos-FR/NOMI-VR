...
namespace nomivr {
  ...
  static const char *const k_pch_Driver_Section = "driver_nomivr";
  ...
  class nomivrDevice: public vr::ITrackedDeviceServerDriver {
  public:
    nomivrDevice(std::string myserial, std::string deviceBreed): m_sSerialNumber(myserial) {
      // boilerplate
  ...
  protected:
    ...
    std::shared_ptr<nomivrExtendedDisplayComponent> m_spExtDisplayComp;
