...
#ifndef nomivr_COMPONENTS_H
#define nomivr_COMPONENTS_H

namespace nomivr {
  static const char *const k_pch_ExtDisplay_Section = "nomivr_extendedDisplay";
  ...
  static const bool g_bnomivrExtDisplayComp_doLensStuff = true;
  class nomivrExtendedDisplayComponent: public vr::IVRDisplayComponent {
  public:
    nomivrExtendedDisplayComponent(){
    ...
    virtual vr::DistortionCoordinates_t ComputeDistortion(vr::EVREye eEye, float fU,
      ...
      if constexpr(g_bnomivrExtDisplayComp_doLensStuff) {
